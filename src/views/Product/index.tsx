...
const ProductView = ({ product }: SingleProduct) => {
  return (
    <Fragment>
        ...
        <div className="block grid-cols-9 items-start gap-x-10 pb-10 pt-7 lg:grid lg:pb-14 xl:gap-x-14 2xl:pb-20">
          ...
          <div className="col-span-4 pt-8 lg:pt-0">
            ...
            <div className="space-s-4 3xl:pr-48 flex items-center gap-2 border-b border-gray-300 py-8  md:pr-32 lg:pr-12 2xl:pr-32">
              ...
              <Button className="h-11 w-full rounded-md bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black">
                Add to cart
              </Button>
            </div>
            <div className="py-6 ">
